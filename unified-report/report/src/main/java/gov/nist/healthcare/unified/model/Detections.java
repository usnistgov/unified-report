...
public class Detections extends Section {
	...
	public ArrayList<Section> entries() {
		ArrayList<Section> e = new ArrayList<Section>();
		for (Classification c : cl) {
			for (String k : c.keys()) {
				try {
					Collection col = c.getArray(k);
					for(int i = 0; i < col.size(); i++)
						e.add(col.getObject(i));
	...
	@Override
	public Classification getObject(String k) throws NotFoundException,
			ConversionException {
		Section s;
		String search = k;
		String cla = k;
	...
	@Override
	public Collection getArray(String k) throws NotFoundException,
			ConversionException {
		Section s;
		String search = k;
		String cla = k;
	...
	@Override
	public String getString(String k) throws NotFoundException,
			ConversionException {
		Section s;
		String search = k;
		String cla = k;
	...
	@Override
	public Integer getInt(String k) throws NotFoundException,
			ConversionException {
		Section s;
		String search = k;
		String cla = k;
	...
	public void put(ArrayList<Section> detections) throws NotFoundException,
			ConversionException {
