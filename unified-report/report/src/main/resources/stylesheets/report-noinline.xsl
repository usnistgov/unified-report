...
<xsl:stylesheet exclude-result-prefixes="map" version="1.0"
                    ...
                    <tbody>
                        <tr class="row1">
                            ...
                            <td align="right">
                                ...
                                <input type="checkbox" style="margin-left : 10px;" class="toggle-visibility">
        ...
        <tbody>
            <tr>
                ...
                <td class="row5 border_bottom" align="right">
                    ...
                    <input type="checkbox" checked="true" style="margin-left : 10px;" class="toggle-visibility-c">
                        <xsl:attribute name="data-target">
                            <xsl:value-of select="@Result"/><xsl:value-of select="@Type"/>
                        </xsl:attribute>
                    </input>
                </td>
            </tr>
                    ...
                    <tr>
                        ...
                        <xsl:choose>
                            <xsl:when test="report:Er7MessageHexFormatted">
                                <button class="show-sep">
                                    <xsl:attribute name="data-id"><xsl:value-of select="generate-id()"/></xsl:attribute>
                        ...
                        <td class="row6 " style="color: red; font-weight: bold">
                            <xsl:if test="$excluded != 'error'">
                                <input checked="true" type="checkbox"
                                    class="toggle-visibility" style="margin-left : 10px;" data-target="error" />
                            </xsl:if>
                        ...
                        <td class="row6 " style="color: maroon; font-weight: bold">
                            <xsl:if test="$excluded != 'alert'">
                                <input type="checkbox" class="toggle-visibility"
                                    style="margin-left : 10px;" data-target="alert" />
                            </xsl:if>
                    ...
                    <tr class="border_bottom">
                        <td class="row6 " style="color: #FF9933; font-weight: bold">
                            <xsl:if test="$excluded != 'warning'">
                                <input type="checkbox" class="toggle-visibility"
                                    style="margin-left : 10px;" data-target="warning" />
                            </xsl:if>
                    ...
                    <tr class="border_bottom">
                        <td class="row6" style="color: green; font-weight: bold">
                            <xsl:if test="$excluded != 'affirmative'">
                                <input type="checkbox" class="toggle-visibility"
                                    style="margin-left : 10px;" data-target="affirmative" />
                            </xsl:if>
                    ...
                    <tr class="border_bottom">
                        <td class="row6" style="color: green; font-weight: bold">
                            <xsl:if test="$excluded != 'spec-error'">
                                <input type="checkbox" class="toggle-visibility"
                                    style="margin-left : 10px;" data-target="spec-error" />
                            </xsl:if>
    ...
    <xsl:template match="report:MetaData/report:Context/context:FailureInterpretation">
        <div class="report-section">
            <table class="forumline" width="100%" cellspacing="1"
                cellpadding="2">
                <tr class="row1">
                    ...
                    <td align="right" style="border-bottom:2pt #005C99 solid">
                        <button id="btn" class="failure-toggle-btn">View</button>
                    </td>
                </tr>
